...
import sssdnsy.cache.local.interfaces.IReadOnlyCache;
import sssdnsy.cache.local.interfaces.IReadWriteCache;
...
public class CacheFactory {
    ...
    private static final void initReadWriteCaches(List<CacheXml.ReadWriteCacheItem> items) {
        ...
        while (i$.hasNext()) {
            CacheXml.ReadWriteCacheItem item = (CacheXml.ReadWriteCacheItem) i$.next();
