package net.netty.demo14.client;

import io.netty.channel.ChannelHandlerContext;
import io.netty.channel.ChannelInboundHandlerAdapter;
import io.netty.channel.socket.SocketChannel;
import net.netty.demo14.domain.Constants;
import net.netty.demo14.domain.FileBurstData;
import net.netty.demo14.domain.FileBurstInstruct;
import net.netty.demo14.domain.FileTransferProtocol;
import net.netty.demo14.util.FileUtil;
import net.netty.demo14.util.MsgUtil;
...
/**
 * @author fun.pengzh
 * @class net.netty.demo14.client.MyClientHandler
 * @desc
 * @since 2022-05-15
 */
