package lang.features.reflection;
...
//            源代码不需要发生任何变化，只需要修改配置文件，就可以导致程序的逻辑发生变化， 这是一种基于配置的编程思想。
            BufferedReader bf = new BufferedReader(new FileReader("W:\\code\\algorithm\\one-stop-java\\src\\main\\java\\lang\\reflection\\context.conf"));
