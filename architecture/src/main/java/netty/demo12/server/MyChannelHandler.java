...
/**
 * @author fun.pengzh
 * @class netty.demo12.server.MyChannelHandler
 * @desc
 * @since 2022-05-11
 */
public class MyChannelHandler extends ChannelInboundHandlerAdapter {

    private transient final Logger log = LoggerFactory.getLogger(netty.demo4.MyChannelHandler.class);
